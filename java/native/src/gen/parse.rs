...
//! other pointers.
//!
//! `syn` does not expand macros, but 59 of the 444 exported functions are
...
mod tests {
    ...
    fn finds_every_exported_ffi_function() {
        ...
        // reports 444 at develop 748e7db8. That is 385 functions written out
        // literally plus 59 generated by five macro_rules! macros. This
        // assertion is intentionally exact so an FFI change forces a deliberate
        // update here.
        assert_eq!(fns.len(), 444, "exported FFI function count changed");
    }
