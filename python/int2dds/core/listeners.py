...
from int2dds.core import conditions as _conditions
...
# Status mask constants. The bits come from `conditions`, which holds the only copy
# and is what `ffi/tests/abi_parity.rs` pins against the header; these two are
# binding-side conveniences with no `INT2DDS_STATUS_*` of their own.
STATUS_MASK_NONE = 0
STATUS_MASK_ALL = 0xFFFFFFFF
STATUS_INCONSISTENT_TOPIC = _conditions.STATUS_INCONSISTENT_TOPIC
STATUS_OFFERED_DEADLINE_MISSED = _conditions.STATUS_OFFERED_DEADLINE_MISSED
STATUS_REQUESTED_DEADLINE_MISSED = _conditions.STATUS_REQUESTED_DEADLINE_MISSED
STATUS_OFFERED_INCOMPATIBLE_TYPE = _conditions.STATUS_OFFERED_INCOMPATIBLE_TYPE
STATUS_REQUESTED_INCOMPATIBLE_TYPE = _conditions.STATUS_REQUESTED_INCOMPATIBLE_TYPE
STATUS_OFFERED_INCOMPATIBLE_QOS = _conditions.STATUS_OFFERED_INCOMPATIBLE_QOS
STATUS_REQUESTED_INCOMPATIBLE_QOS = _conditions.STATUS_REQUESTED_INCOMPATIBLE_QOS
STATUS_SAMPLE_LOST = _conditions.STATUS_SAMPLE_LOST
STATUS_SAMPLE_REJECTED = _conditions.STATUS_SAMPLE_REJECTED
STATUS_DATA_ON_READERS = _conditions.STATUS_DATA_ON_READERS
STATUS_DATA_AVAILABLE = _conditions.STATUS_DATA_AVAILABLE
STATUS_LIVELINESS_LOST = _conditions.STATUS_LIVELINESS_LOST
STATUS_LIVELINESS_CHANGED = _conditions.STATUS_LIVELINESS_CHANGED
STATUS_PUBLICATION_MATCHED = _conditions.STATUS_PUBLICATION_MATCHED
STATUS_SUBSCRIPTION_MATCHED = _conditions.STATUS_SUBSCRIPTION_MATCHED
