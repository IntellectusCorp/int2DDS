//! Configuration parameters for Requester and Replier (Spec 7.11.1.4.11, 7.11.1.4.12)
...
/// Configuration for constructing a Requester (Spec 7.11.1.4.11)
...
/// Configuration for constructing a Replier (Spec 7.11.1.4.12)
