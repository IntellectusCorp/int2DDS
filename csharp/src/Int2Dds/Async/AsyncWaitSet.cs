...
namespace Int2Dds.Async
{
    ...
    public sealed class AsyncWaitSet : IAsyncDisposable, IDisposable
    {
        ...
        /// </summary>
        internal void AttachDataReader(IntPtr readerHandle) => _waitSet.AttachDataReader(readerHandle);

        /// <summary>
        /// Detaches a DataReader by its native handle.
        /// </summary>
        internal void DetachDataReader(IntPtr readerHandle) => _waitSet.DetachDataReader(readerHandle);

        /// <summary>
        /// Attaches a DataWriter by its native handle.
        /// </summary>
        internal void AttachDataWriter(IntPtr writerHandle) => _waitSet.AttachDataWriter(writerHandle);

        /// <summary>
        /// Detaches a DataWriter by its native handle.
        /// </summary>
        internal void DetachDataWriter(IntPtr writerHandle) => _waitSet.DetachDataWriter(writerHandle);
